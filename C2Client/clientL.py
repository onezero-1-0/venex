...
class C2Client:
    ...
    def setup_dark_theme(self):
        ...
        # self.tree_bg = "#1f1f1f"
        # self.tree_fg = "#ffffff"
        # self.tree_selected = "#363434"
        # self.text_bg = "#3c3c3c"
        # self.text_fg = "#ffffff"
        # self.frame_bg = "#2e2e2e"
        # Configure darker theme colors
        # Configure white/light theme colors
        ...
        if message.startswith("TARGET:"):
            ...
            for line in lines:
                if line.strip():  # optional: skip empty lines
                    self.gui_queue.put((self.log_message, (f"$$-> {line}", False, "#002BB8",)))
        else:
            self.gui_queue.put((self.log_message, (f"Received: {message}",)))
    ...
    def log_message(self, message, times=True, color="black"):
